...
- **Diárias concluídas na semana**: só as **diárias** com estado **concluído** deixam de aparecer nas colunas e são listadas num painel **abaixo** da grelha (canto à direita em LTR), com **data** e os mesmos controlos (⋮, lápis, ✓). Cada diária entra **uma vez** na lista (primeiro dia da semana em que entra na vista)
- **Atividades (todos) concluídas na semana**: painel **adicional** com **todos** com `due_date` nos dias visíveis e estado **concluído**; serve de resumo **abaixo** da grelha (junto do painel de diárias). Continuam **também** visíveis no calendário no respetivo dia
